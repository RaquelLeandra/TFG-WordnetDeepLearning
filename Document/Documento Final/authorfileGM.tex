...
\end{tikzpicture}
  ...
  \label{fig:sub2}
\end{subfigure}
\caption{Conjuntos de synsets que estudiaremos}
\label{fig:test}
\end{figure}
...
\begin{itemize}
\item Analizar las diferencias entre los tres \textit{full-network embedding}(Cantidad de características con valor 1, 0 y -1, distribución de las características en el embedding etc.). 
